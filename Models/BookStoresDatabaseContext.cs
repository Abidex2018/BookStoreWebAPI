...
{
    public partial class BookStoresDatabaseContext : DbContext
    {
        public BookStoresDatabaseContext()
        {
        }

        public BookStoresDatabaseContext(DbContextOptions<BookStoresDatabaseContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Book>(entity =>
            {
                ...
                entity.HasOne(d => d.Pub)
                    ...
                    .HasConstraintName("FK__Book__pub_id__3A81B327");
            });
            ...
            modelBuilder.Entity<BookAuthor>(entity =>
            {
                ...
                entity.HasOne(d => d.Book)
                    ...
                    .HasConstraintName("FK__BookAutho__book___3C69FB99");
            });
            ...
            modelBuilder.Entity<Publisher>(entity =>
            {
                entity.HasKey(e => e.PubId)
                    .HasName("PK__Publishe__2515F2228E7F4A5A");
            ...
            modelBuilder.Entity<RefreshToken>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasConstraintName("FK__RefreshTo__user___3D5E1FD2");
            });
            ...
            modelBuilder.Entity<Sale>(entity =>
            {
                ...
                entity.HasOne(d => d.Book)
                    .WithMany(p => p.Sales)
                    .HasForeignKey(d => d.BookId)
                    .HasConstraintName("FK__Sale__book_id__3E52440B");

                entity.HasOne(d => d.Store)
                    .WithMany(p => p.Sales)
                    .HasForeignKey(d => d.StoreId)
                    .HasConstraintName("FK__Sale__store_id__3F466844");
            });
            ...
            modelBuilder.Entity<User>(entity =>
            {
                ...
                entity.HasOne(d => d.Job)
                    ...
                    .HasConstraintName("FK__User__job_id__403A8C7D");
